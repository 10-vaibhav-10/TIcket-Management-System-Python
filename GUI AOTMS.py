...
MN404 T4 2025 Group Assignment
Team Members: Kopila Baral, Soab Karki and Vaibhav Singh Thapa
Date: [Submission Date]

Features Implemented:
- User authentication system
- Ticket price calculation with age/concession rules
...
class AOTMS_GUI:
    ...
    def create_ticket_calculator(self):
        ...
        ttk.Button(self.right_frame, text="Back to Ticket Details", command=self.toggle_calculation_view).pack(pady=10)
    ...
    def update_ticket_limits(self, event=None):
        ...
        if ticket_type == "Rod Laver Arena (Reserved)":
            ...
            self.special_session_menu.current(0)
            self.session_var.trace_add("write", lambda *args: self.update_ticket_limits())
    ...
    def add_ticket_details(self):
        ...
        try:
            ...
            self._update_inventory(ticket_type, quantity, session)
